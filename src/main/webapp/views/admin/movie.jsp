            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <a href="/movie_war/api/getMovie" id="defaultModalButton" data-modal-toggle="defaultModal"
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div id="actionsDropdown"
                                ...
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="#"
                                           class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Phim
                                            sắp chiếu</a>
                                    </li>
                                </ul>
                                <div class="py-1">
                ...
                <div class="overflow-x-auto h-[550px]">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            <th scope="col" class="px-4 py-3">Phim</th>
                            <th scope="col" class="px-4 py-3">Thời lượng</th>
                            <th scope="col" class="px-4 py-3">Ngày phát hành</th>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    <div class="overflow-hidden rounded-lg">
                                        <img src="https://1.bp.blogspot.com/-pR35XvlJTGo/YBEDHXZbzPI/AAAAAAAAEjE/_V5nYUGHjnQOhYVws3bjX_LKbUCmY6O2wCLcBGAsYHQ/s1034/raya-e-o-ultimo-dragao-trailer-disney.jpg"
                                             alt="" class="h-12">
                                    </div>
                                    <span class="">
                                            <a href="<c:url value="/api/getMovie?id=${movie.id}"/>">
                                                ${movie.name}
                                            </a>
                                    </span>
                                </th>
                                <td class="px-4 py-3 text-sm font-medium">${movie.time}</td>
                                <td class="px-4 py-3 text-sm font-medium">${movie.releaseDate}</td>
