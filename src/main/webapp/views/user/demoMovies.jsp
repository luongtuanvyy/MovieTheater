...
<main>
    <form class="openning" action="findMovieType" method="get">
        ...
        <div class="grid grid-cols-10 gap-4">
            <div class="col-start-2 col-span-2">
                ...
                <select name="movieType" id="underline_selec"
            ...
            <div class="col-span-2">
                ...
                <select name="movieType2" id="underline_select"
                        class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                    <option selected>Choose a country</option>
                    <option value="US">United States</option>
                    <option value="CA">Canada</option>
            ...
            <div class="col-span-2">
                ...
                <select name="movieType3" id="underline"
                        class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                    <option selected>Choose a country</option>
                    <option value="US">United States</option>
                    <option value="CA">Canada</option>
            ...
            <div class="col-span-2 flex items-end justify-evenly">
                <button type="submit" class="py-2.5 px-5 text-sm font-medium text-gray-900
